...
public class TofuLeftMovement : MonoBehaviour
{
    //Movement speed of Tofu_Left
    ...
    void Update()
    {
        //If stop is false then change velocity value to leftMoveSpeed
        if (stop == false)
        {
            velocity = leftMoveSpeed;
        }
        //If stop is true then stop all Tofu_Left velocity
        if (stop == true)
        {
            velocity = 0;
        }
